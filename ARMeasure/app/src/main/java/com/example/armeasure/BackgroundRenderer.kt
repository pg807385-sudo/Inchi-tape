...
/**
 * Draws the live camera feed as a full-screen background using an external OES texture,
 * the same technique ARCore's own samples use. This texture is what ARCore's Session
 * writes each camera frame into.
 */
